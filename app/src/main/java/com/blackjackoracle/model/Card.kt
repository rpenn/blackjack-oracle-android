...
data class Card(val suit: Suit, val rank: Int) : Serializable {
    ...
    val blackjackValue: Int get() = when (rank) { 14 -> 11; in 11..13 -> 10; else -> rank }
    val isAce: Boolean get() = rank == 14
    val hasTenValue: Boolean get() = rank in 10..13
    val rankLabel: String get() = when (rank) { 14 -> "A"; 13 -> "K"; 12 -> "Q"; 11 -> "J"; else -> rank.toString() }
    val rankWord: String get() = when (rank) { 14 -> "Ace"; 13 -> "King"; 12 -> "Queen"; 11 -> "Jack"; 10 -> "Ten"; 9 -> "Nine"; 8 -> "Eight"; 7 -> "Seven"; 6 -> "Six"; 5 -> "Five"; 4 -> "Four"; 3 -> "Three"; 2 -> "Two"; else -> rank.toString() }
